...
ComponentTaskListFactory =
	...
	UserTaskList:
		createCompleted: (userIdToWatch) ->
			userTaskList = new ComponentTaskList ComponentTaskListFactory.userTaskDetailSelection, yes
		...
		createNotCompleted: (userIdToWatch) ->
			userTaskList = new ComponentTaskList ComponentTaskListFactory.userTaskDetailSelection, no
	...
	BuddyTaskList: 
		createCompleted: (userIdToWatch) ->
			buddyTaskList = new ComponentTaskList ComponentTaskListFactory.baseTaskDetailSelection, yes
			...
			buddyTaskList
		createNotCompleted: (userIdToWatch) ->
			buddyTaskList = new ComponentTaskList ComponentTaskListFactory.baseTaskDetailSelection, no
	...
	ManagerTaskList:
		createCompleted: ->
			managerList = new ComponentTaskList ComponentTaskListFactory.baseTaskDetailSelection, yes
			...
			managerList
		createNotCompleted: ->
			managerList = new ComponentTaskList ComponentTaskListFactory.baseTaskDetailSelection, no
