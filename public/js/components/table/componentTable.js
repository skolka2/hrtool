(function() {
  ...
  ComponentTable = (function(_super) {
    ...
    ComponentTable.prototype.handleOnFilter = function(filterParams) {
    ...
    ComponentTable.prototype.onLoad = function(data) {
      var divLoadMore, divTable, item, _i, _len;
      divTable = this.getDivTable();
      divLoadMore = this.getDivLoadMore();
      ...
      for (_i = 0, _len = data.length; _i < _len; _i++) {
        item = data[_i];
        this.addRow(item, divTable);
      }
      this.reqData.offset += data.length;
    };
