...
module.exports = function(dbClient){
	...
	return{
         ...
         */
         ...
         getUserTasks : function(userId, next, completed){
          var whereClause = '';

          if(completed == true) whereClause = ' AND t.completed';
          else if(completed == false) whereClause = ' AND NOT t.completed';
          else whereClause = '';
         	...
         	dbClient.queryAll('SELECT t.*, u.email AS buddy_email, u.last_name AS buddy_last_name, u.first_name AS buddy_first_name \
              ...
              WHERE t.id_user=$1'+whereClause, [userId], next);
         },

         getBuddyTasks : function(userId, next, completed){
          var whereClause = '';
          ...
          if(completed == true) whereClause = ' AND t.completed';
         	...
         	dbClient.queryAll('SELECT t.*, u.* \
         		  ...
         		  WHERE t.id_buddy = $1'+whereClause,[userId], next);
         },
