	...
	return{
         ...
         */
         ...
         getBuddyTasks : function(userId, next){			
         	dbClient.queryAll('SELECT t.*, u.*, d.title department, te.title team \
         		FROM tasks t \
         		JOIN users u ON u.id_user = t.id_user \
         		LEFT JOIN teams te ON te.id_team = t.id_team \
         ...
         getTeamTasks : function(userId, next){			
         	dbClient.queryAll('SELECT t.* , u.*, d.title department, te.title team \
         		...
         		LEFT JOIN teams te ON t.id_team = te.id_team \
         		LEFT JOIN  departments d ON t.id_department =d.id_department \
